...
public interface BookService {
    List<BookDto> getAllBooks() throws UnexpectedException;
    BookDto getBookById(Long id) throws BookNotFoundException, UnexpectedException;
    BookDto createBook(BookDto bookDto) throws BookNotCreatedException, UnexpectedException;
